...
class BillModel(Base):
    ...
    parliament: Mapped[int] = mapped_column(
    ...
    law_status: Mapped[Optional[str]] = mapped_column(
...
class PoliticianModel(Base):
    ...
    current_party: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, index=True)
    current_riding: Mapped[Optional[str]] = mapped_column(
        String(200), nullable=True, index=True)
    current_role: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True)

    # All memberships (historical)
    memberships: Mapped[Optional[List[dict]]
                        ] = mapped_column(JSON, nullable=True)

    # External IDs
    parl_mp_id: Mapped[Optional[str]] = mapped_column(
    ...
    # Indexes
    __table_args__ = (
        Index('idx_politician_party_riding',
...
class FetchLogModel(Base):
    ...
    error_count: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0)
    error_summary: Mapped[Optional[List[dict]]
                          ] = mapped_column(JSON, nullable=True)
...
class PartyModel(Base):
    ...
    short_name_en: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True)
    short_name_fr: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True)
    ...
    __table_args__ = (
        UniqueConstraint('jurisdiction', 'name_en',
                         name='uq_party_natural_key'),
    )
...
class RidingModel(Base):
    ...
    riding_code: Mapped[Optional[str]] = mapped_column(
        String(20), nullable=True)
...
class VoteModel(Base):
    ...
    vote_date: Mapped[datetime] = mapped_column(
        DateTime, nullable=False, index=True)
    vote_description_en: Mapped[Optional[str]
                                ] = mapped_column(Text, nullable=True)
    vote_description_fr: Mapped[Optional[str]
                                ] = mapped_column(Text, nullable=True)
    bill_id: Mapped[Optional[int]] = mapped_column(
        Integer, ForeignKey('bills.id'), nullable=True, index=True)
    ...
    __table_args__ = (
        UniqueConstraint('jurisdiction', 'vote_id',
                         name='uq_vote_natural_key'),
...
class VoteRecordModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint('vote_id', 'politician_id',
                         name='uq_vote_record_natural_key'),
    )
...
class CommitteeModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True)
    natural_id: Mapped[str] = mapped_column(
    ...
    committee_code: Mapped[str] = mapped_column(
        String(50), nullable=False, index=True)
    committee_slug: Mapped[str] = mapped_column(
        String(100), nullable=False, index=True)
    acronym_en: Mapped[str] = mapped_column(String(50), nullable=False)
    acronym_fr: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True)
    source_slug: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True)
    name_en: Mapped[str] = mapped_column(String(200), nullable=False)
    name_fr: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    short_name_en: Mapped[Optional[str]] = mapped_column(
    ...
    short_name_fr: Mapped[Optional[str]] = mapped_column(
        String(200), nullable=True)
    chamber: Mapped[str] = mapped_column(String(50), nullable=False)
    parent_committee: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True)
    source_url: Mapped[Optional[str]] = mapped_column(
        String(500), nullable=True)
    committee_type: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True)
    website_url: Mapped[Optional[str]] = mapped_column(
        String(500), nullable=True)
    ...
    __table_args__ = (
        UniqueConstraint('jurisdiction', 'committee_code',
                         name='uq_committee_natural_key'),
        UniqueConstraint('committee_slug', name='uq_committee_slug'),
        UniqueConstraint('jurisdiction', 'acronym_en',
                         name='uq_committee_acronym'),
...
class DebateModel(Base):
    ...
    parliament: Mapped[int] = mapped_column(
        Integer, nullable=False, index=True)
    session: Mapped[int] = mapped_column(Integer, nullable=False, index=True)
    sitting_date: Mapped[datetime] = mapped_column(
        DateTime, nullable=False, index=True)
    chamber: Mapped[str] = mapped_column(String(50), nullable=False)
    debate_type: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True)
    ...
    __table_args__ = (
        UniqueConstraint('jurisdiction', 'hansard_id',
                         name='uq_debate_natural_key'),
...
class SpeechModel(Base):
    ...
    politician_id: Mapped[Optional[int]] = mapped_column(
    ...
    timestamp_start: Mapped[Optional[time]] = mapped_column(
        sa.Time(), nullable=True)
    timestamp_end: Mapped[Optional[time]] = mapped_column(
        sa.Time(), nullable=True)
    ...
    __table_args__ = (
        UniqueConstraint('debate_id', 'sequence',
                         name='uq_speech_natural_key'),
    )
...
class DocumentModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint('entity_type', 'entity_id', 'content_type',
                         'language', name='uq_document_natural_key'),
...
class RankingModel(Base):
    ...
    score_breakdown: Mapped[Optional[dict]
                            ] = mapped_column(JSON, nullable=True)
...
class IgnoredBillModel(Base):
    ...
    natural_id: Mapped[str] = mapped_column(
        String(255), nullable=False, comment="Unique identifier for this ignore record")
    jurisdiction: Mapped[str] = mapped_column(
        String(50), nullable=False, comment="Jurisdiction (e.g., ca-federal)")
    device_id: Mapped[str] = mapped_column(
        String(255), nullable=False, comment="Anonymous device identifier")
    bill_id: Mapped[int] = mapped_column(Integer, ForeignKey(
        'bills.id', ondelete='CASCADE'), nullable=False, comment="Foreign key to bills.id")
    ...
    __table_args__ = (
        PrimaryKeyConstraint('natural_id', 'jurisdiction',
                             name='pk_ignored_bill'),
...
class PersonalizedFeedTokenModel(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, autoincrement=True)
    natural_id: Mapped[str] = mapped_column(
        String(255), nullable=False, comment="Token UUID")
    jurisdiction: Mapped[str] = mapped_column(
        String(50), nullable=False, comment="Jurisdiction (e.g., ca-federal)")
    device_id: Mapped[str] = mapped_column(
        String(255), nullable=False, comment="Anonymous device identifier")
    token: Mapped[str] = mapped_column(
        String(255), nullable=False, comment="Unique feed token")
    feed_type: Mapped[str] = mapped_column(
        String(50), nullable=False, comment="Type: bills, votes, debates, all")
    filters_json: Mapped[Optional[dict]] = mapped_column(
        JSON, nullable=True, comment="Filter preferences as JSON")
    last_accessed: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True, comment="Last time feed was accessed")
    access_count: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default='0', comment="Number of accesses")
    ...
    __table_args__ = (
        PrimaryKeyConstraint('natural_id', 'jurisdiction',
                             name='pk_personalized_feed_token'),
...
class CommitteeMeetingModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True)
    committee_id: Mapped[int] = mapped_column(Integer, ForeignKey(
        'committees.id', ondelete='CASCADE'), nullable=False, index=True)
    ...
    __table_args__ = (
        UniqueConstraint('committee_id', 'meeting_number', 'parliament',
                         'session', name='uq_committee_meeting_natural_key'),
        Index('idx_committee_meetings_committee_date',
